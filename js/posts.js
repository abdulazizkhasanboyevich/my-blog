const blogPosts = [
  {
    ...
    content: `
      ...
      <p>So'nggi yillarda AI ko'plab oddiy va takroriy ishlarni avtomatlashtirdi. Bugungi mutaxassis ertaga AI bilan raqobatlashishi mumkin. Lekin bu faqat xavf emas Ã¢ÂÂ yangi imkoniyatlar ham yaratmoqda.</p>
      <ul>
      ...
      <p>AI davrida muvaffaqiyatli bo'lish uchun bir narsani tushunish kerak Ã¢ÂÂ AI sizning o'rningizni emas, AI ishlatadigan odam sizning o'rningizni egallaydi.</p>
      ...
      <h2>Xulosa</h2>
      <p>AI davri qo'rqinchli emas Ã¢ÂÂ u yangi imkoniyatlar davri. Vibe coding, AI yordamchi dasturlar va zamonaviy toollarni o'rganish orqali siz ham bu o'zgarishdan foyda olishingiz mumkin. Muhimi Ã¢ÂÂ o'rganishni to'xtatmaslik!</p>
    `
  },
  {
    ...
    content: `
      <p>We've all been there ÃÂ¢ÃÂÃÂ staring at a tangled mess of logic, convinced the solution needs to be complex because the problem feels complex. But more often than not, the clearest code comes from the simplest mental model.</p>
      ...
      <blockquote>The best code reads like well-written prose ÃÂ¢ÃÂÃÂ each function has a clear purpose, and the flow is obvious to anyone who picks it up.</blockquot
      ...
      <p>Clarity isn't about writing less ÃÂ¢ÃÂÃÂ it's about making every line earn its place on the screen.</p>
    `
  }
];
